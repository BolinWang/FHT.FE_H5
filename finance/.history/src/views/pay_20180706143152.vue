<template>
  <div class="container">
    <video id="__video_84342" class="video-4948d5" src="blob:https://www.douyu.com/3a43f8c0-6472-483a-b158-275f3497f3df" style="width: 648px; height: 364.5px; left: 0px; top: 0.25px; transform: rotate(0deg) scale(1) translateZ(0px);"></video>
    <van-nav-bar
      title="选择支付方式"
      left-text=""
      left-arrow
