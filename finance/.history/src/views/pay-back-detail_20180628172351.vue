<template>
  <div class="container">
          ...
          <div class="list-top van-hairline--bottom">
            ...
            <van-row>
              <van-col span="6" offset="1">租金金额</van-col>
               <van-col span="10">{{toLocaleString(billDetail.rentFee)}}</van-col>
            </van-row>
            <van-row>
              <van-col span="6" offset="1">利息</van-col>
               <van-col span="10">{{toLocaleString(billDetail.interest)}}</van-col>
            </van-row>
            <van-row>
            ...
            <van-row>
              <van-col span="6" offset="1">逾期金额</van-col>
               <van-col span="10">{{toLocaleString(billDetail.overdueFee)}}</van-col>
            </van-row>
            <van-row>
              <van-col span="6" offset="1">违约金</van-col>
               <van-col span="10">{{toLocaleString(billDetail.dedit)}}</van-col>
            </van-row>
            <van-row>
              <van-col span="6" offset="1">总还款金额</van-col>
               <van-col span="10">{{toLocaleString(billDetail.repayAmt)}}</van-col>
            </van-row>
            <van-row>
    ...
    <van-row class="footer" v-show="billDetail.status == '00'" @click.native="toPay">
