  ...
  <div id="mj-container">
        ...
        >
          ...
          >
            <div class="room-pic">
              <img
                alt=""
                v-lazy.roomListWrapper="item.pic"
              >
            </div>
            <div class="room-info">
              ...
              <div class="room-address">
                <div class="room-tags">
                  <span
                    v-for="(tag, tagIndex) in item.showTagList"
                    :key="tagIndex"
          ...
          <div
            slot="top"
            class="mint-loadmore-top mint-loadmore-tips"
          >
            <span
          ...
          <div
            slot="bottom"
            class="mint-loadmore-bottom mint-loadmore-tips"
          >
            <span
    ...
    >
      <div class="rentType-list">
        <label
          :for="`rentType${index}`"
          v-for="(item, index) in rentTypeList"
          :key="index"
        >
          <input
            type="radio"
      ...
      <div class="moreInfo-list">
        ...
        <div class="moreInfo-checkBtn">
          <mt-button
            type="default"
            size="small"
            @click="resetMoreInfoOptions"
          >重置</mt-button>
          <mt-button
            type="primary"
            size="small"
            @click="getMoreInfoOptions"
          >确定</mt-button>
        </div>
      </div>
    </mt-popup>
    ...
    >
      <div class="search-head">
        ...
        <div
          class="back"
          @click="keywords='';showSearch=false;searchRoomList=[]"
        >取消</div>
      </div>
      <div
        class="search-container"
        v-show="this.historySearch.length && !this.searchRoomList.length"
      >
        <div class="title">
          搜索历史
          <span
...
import { queryDistrictListApi, queryCityListApi, queryRoomListBySearchApi } from '~/api/index'
export default {
  data() {
    return {
      curCityIndex: null,
    ...
    getCurrentPosition() {
      if (window.AMap) {
        ...
        geolocation.getCurrentPosition((status, result) => {
          console.log(result)
          if (status == 'complete') {
            let getCurrentPositionCity = result.addressComponent.city || '杭州';
            let filterItemIndex
