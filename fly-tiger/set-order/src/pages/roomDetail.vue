<template>
  <div class="room-detail-container">
        ...
        <div class="facility-list">
          <div 
            ...
            <div v-if="item.type == -1" @click="$modal.show('device-modal')">
              <img :src="require(`../images/estate-service/more.png`)" alt="">
              <p>{{item.name}}</p>
            </div>
            <div v-else>
              <img :src="require(`../images/estate-service/${item.type}.png`)" alt="">
              <p>{{item.name}}</p>
            </div>
          </div>
        </div>
        ...
        <div v-if="nowDevice==0">
          ...
          <div class="facility-list">
            <div 
              ...
              v-for="(item, index) in showDeviceList">
              <div v-if="item.type == -1" @click="$modal.show('device-modal')">
                <img :src="require(`../images/device-${item.type}.png`)" alt="">
                <p>{{item.name}}</p>
              </div>
              <div v-else>
                <img :src="require(`../images/device-${item.type}.png`)" alt="">
    ...
    <div class="fixed-bottom" v-if="isRent">
      <span class="btn btn-disabled">已出租</span>
    </div>
    <div class="fixed-bottom" v-else :class="{'hide': hideFooter}">
      <a class="btn btn-default" :href="`tel:${phone}`">联系管家</a>
      <span class="btn btn-primary" @click="addAppointment(5)">加入约看</span>
    </div>
    <modal 
        ...
        <ul>
          ...
          >
            <div class="device-row">
              <span>{{item.name}}</span>
              <span>
                <img v-if="type==1" :src="require(`../images/estate-service/${item.type}.png`)" alt="">
                <img v-else :src="require(`../images/device-${item.type}.png`)" alt="">
              </span>
            </div>
          </li>
        </ul>
  ...
  methods: {
    initRoomInfo() {
      if(this.$route.query){
        ...
        this.hideFooter = searchObj['hideFooter'] || false;
    ...
    addAppointment() {
      this.$store.commit('addOrder', this.roomId);
      this.$router.push('/');
    }
  },
  filters: {
...
.back-btn {
  ...
  width: 0.4rem;
  height: 0.4rem;
  background-image: url(../images/turn-back-w.png);
...
.mj-modal {
  ...
  .modal-head {
    ...
    .close-btn {
      ...
      width: 1.28rem;
      height: 1.28rem;
      @include bgFill("../images/close-btn.png");
    }
  }
}
.modal-list-item {
