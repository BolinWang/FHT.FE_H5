<template>
    ...
    <mt-popup
      ...
      <div class="checkCode-container">
        ...
        <span class="active" @click="showContract = true">《麦邻租房用户协议》</span>
      </div>
...
<!--       <div class="btn-container">
    ...
    <mt-popup
      ...
      <div class="contract-container">
        <p>请务必认真阅读和理解本《用户服务协议》（以下简称《协议》）中规定的所有权利和限制。除非您接受本《协议》条款，否则您无权注册、登录或使用本协议所涉及的相关服务。您一旦注册、登录、使用或以任何方式使用本《协议》所涉及的相关服务的行为将视为对本《协议》的接受，即表示您同意接受本《协议》各项条款的约束。如果您不同意本《协议》中的条款，请不要注册、登录或使用本《协议》相关服务。 本《协议》是用户与“麦邻租房”平台之间的法律协议。</p>
        <h4 style="font-weight:700;">1. 接受</h4>
        <p>本协议内容包括协议正文以及所有“麦邻租房”平台已经发布或将来发布的各类规则（包括但不限于法律声明、隐私条款等）。所有规则为本协议不可分割的一部分，与本协议正文具有同等法律效力。</p>
        <p>以任何方式进入“麦邻租房”平台并使用“服务”即表示您已经阅读本协议并同意与“麦邻租房”平台订立本协议，且您将受本协议的条款和条件(下称“条款”)的约束。本协议在必要时将随时进行修改更新，每次改动都会在“麦邻租房”平台上刊载公告，通知予您。如您不同意相关变更，必须停止使用“服务”。经修订的“条款”一经在“麦邻租房”平台公布后，立即自动生效。您登录或继续使用“服务”即表示您已阅读并接受经修订的协议。</p>
        <p>当您与“麦邻租房”平台发生争议时，应以最新的条款为准。除另行明确声明外，任何使“服务”范围扩大或功能增强的新内容均受本协议约束。</p>
        <h4 style="font-weight:700;">2.服务对象</h4>
        <p>“服务”仅供能够完全民事行为能力的民事主体，具有达成合约履行其义务的能力个人或公司使用。若您不具备此资格，请不要使用“麦邻租房”平台提供的服务。</p>
        <p>“麦邻租房”平台有权根据实际情况随时调整服务内容，并无需对任何人或第三方负责。</p>
        <h4 style="font-weight:700;">3.会员帐号和保密</h4>
        <p>在使用本服务前，您必须先行注册，取得本公司提供给您的帐号。您须对您的会员注册手机号和密码负责，您保证不向“麦邻租房”平台工作人员以及其他任何人泄露该帐号及密码，亦不使用其他任何人的帐号及密码。只有您本人或您的合法授权人员可以使用您的帐号，该帐号不可转让、不可赠与、不可继承。在您决定不再使用该帐号时，您应向本公司申请注销该帐号。</p>
        <p>本公司通过您的手机号和密码识别您的指示，请您妥善保管您的手机号和密码，对于因密码泄露所致的损失，由您自行承担。您同意：
        （1）如发现任何人未经授权使用您的手机号或密码，或发生违反保密规定的任何其他情况，您会立即通知“麦邻租房”平台；
        （2) 确保您在每个上网时段结束时，以正确步骤离开网站，避免因您选择自动登录而导致帐号被非法使用。“麦邻租房”平台无需且也不会对因您未能遵守本款规定而发生的任何损失或损毁负责。
        （3)在您确认密码丢失时，向“麦邻租房”平台工作人员申请重置密码。</p>
        <h4 style="font-weight:700;">4. 费用 </h4>
        <p>在您使用本服务时，本公司有权依照“麦邻租房”平台服务收费规则相应的服务收费介绍、订单及/或相关协议向您收取服务费用。具体服务费用以您使用本服务时本网站上所列之收费方式公告或您与本公司达成的其他书面协议为准。</p>
        <p>本公司拥有制订及调整服务费、支付条件之权利，但至少提前30天的时间发出通知或公告，“麦邻租房”平台将以网络公示和/或电信等方式通知。账户欠费的情况下，“麦邻租房”平台有权暂停或终止相应地收费服务，并将终止该账户与服务的连接。</p>
        <h4 style="font-weight:700;">5.注册义务</h4>
        <p>根据会员注册页面提示，输入正确的手机号和密码，完成注册，保证“麦邻租房”平台可以通过您所填写的联系方式与您取得联系。您承诺将及时更新您的会员资料以维持该等信息的有效性。</p>
        <p>在您注册成为“麦邻租房”平台用户时，您授权本公司可以通过向第三者审核您的身份和资格，并取得您使用本服务的相关资料。倘若您提供的资料或信息包含有不正确、不真实的信息，“麦邻租房”平台将保留取消您会员资格并随时结束为您提供服务的权利。</p>
        <p>您在“麦邻租房”平台进行软件许可使用或服务应用过程中应遵守以下条款：</p>
        <p>1) 遵守诚实信用的原则，遵守当地及中国有关法律法规的规定；不得利用该网站进行任何非法活动；遵守所有与使用该网站有关的协议、规定、程序和惯例；不发布各类违法或违规信息；不在“麦邻租房”平台上恶意评价其他用户； </p>
        <p>2) 同意接收来自“麦邻租房”平台及其合作伙伴发出的短信信息；</p>
        <p>3) 对由于您在使用“麦邻租房”平台服务的过程中，违反本协议或通过提及而纳入本协议的条款和规则或帐号违反任何法律或第三方的权利而产生或引起的任何索赔、要求、诉讼、损失和损害而言，无论是已知或未知的，包括合理的律师费，您明确同意就此对“麦邻租房”平台进行补偿并使其免受损害。 </p>
        <h4 style="font-weight:700;">6.服务期限</h4>
        <p>您的订单提交并完成费用支付之日起，为您所购买应用的服务期限起始日期；所购买应用到期日，为应用服务期限结束时间。某一应用服务期届满前，您可按“麦邻租房”平台公布的最新的服务说明继续购买使用此服务。 </p>
        <h4 style="font-weight:700;">7. 服务的终止</h4>
        <p>您同意，在下列情况下，“麦邻租房”平台有权在发出通知或不发出通知的情况下，可立即发出警告，随时停止提供“服务”或其任何部分：</p>
        <p>（1）违反了此协议或已在约定范围内的任一条款；</p>
        <p>（2）根据此协议相关说明而终止服务； </p>
        <p>（3）本协议终止或更新时，明示不愿接受新的服务协议的；</p>
        <p>（4）无法核实或鉴定您向本公司提供的任何资料；</p>
        <p>（5）其它任何违反互联网相关法律法规的信息或“麦邻租房”平台认为需终止服务的情况。</p>
        <p>服务终止后，“麦邻租房”平台没有义务为用户保留原帐号中或与之相关的信息，或转发未曾阅读或发送的信息给用户或第三方。无论因任何原因以任何方式终止服务，“麦邻租房”平台仍有权：（1）保存或不保存该用户的注册数据及以前的交易行为记录；（2）对于用户在服务终止前实施的违法或违约行为，“麦邻租房”平台保留追索。此外，您同意，“麦邻租房”平台不会就终止您接入“服务”而对您或任何第三者承担任何责任。</p>
        <h4 style="font-weight:700;">8. 服务的提供</h4>
        <p>本公司会尽一切努力为您提供最优质的服务，本公司保留在无须发出书面通知，仅在“麦邻租房”平台公示的情况下，暂时或永久地更改或停止部分或全部“服务”的权利。对于“麦邻租房”平台行使修改或中断服务的权利而造成损失的，”麦邻租房”平台不需对用户或任何第三方负责。</p>
        <p>本公司有权修改或变更所提供的收费服务、收费标准、收费方式、服务费及服务条款。“麦邻租房”平台在提供服务时，可能现在或日后对部分服务的用户开始收取一定的费用，如用户拒绝支付该等费用，则不能在收费开始后继续使用相关的服务。但“麦邻租房”平台将尽最大努力通过电邮或其他有效方式通知用户有关的修改或变更。</p>
        ...
        <p>“麦邻租房”平台上所有内容，包括但不限于著作、图片、档案、资讯、资料、网站架构、网站画面的安排、网页设计，均由本公司或其他权利人依法拥有其知识产权，包括但不限于商标权、专利权、著作权、商业秘密等。</p>
        ...
        <p>除非另有明确规定，任何通知应以短信形式发送到您在登记过程中向“麦邻租房”平台提供的手机号码，在短信发出二十四 (24) 小时后，通知应被视为已送达，除非发送人被告知相关手机号码已注销。</p>
        <h4 style="font-weight:700;">13. 不可抗力</h4>
        <p>对于因本公司合理控制范围以外的原因，包括但不限于自然灾害、罢工或骚乱、物质短缺或定量配给、暴动、战争行为、政府行为、通讯或其他设施故障或严重伤亡事故等本公司不能预见、不能避免且不能克服的情况，致使本公司延迟或未能履约的，“麦邻租房”平台可免于承担责任。</p>
        ...
        <p>本协议构成您与“麦邻租房”平台之全部协议，并取代您和“麦邻租房”平台先前就相同事项订立的任何书面或口头协议。但在您使用相关服务、或使用第三方提供的内容或软件时，亦应遵从所适用之附加条款及权利。</p>
        ...
        <p>您对本协议的任何部分之意见及建议可通过客户服务部门与“麦邻租房”平台联系。</p>
      </div>
    </mt-popup>
